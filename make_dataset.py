...
if __name__ == "__main__":
    ...
    train.use_design_loc(os.path.join(train_example_path, 'grbm_rgbd_preprocessed_train_design_dataset.npy'))

    train_pkl_path = os.path.join(train_example_path, 'grbm_rgbd_preprocessed_train_dataset.pkl')
